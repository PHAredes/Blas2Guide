...
The objectives of this project are clarified [here](utils/goals).
...
## [Scene-by-Scene Documentation](scenes/scenes)
...
Please refer to the individual folders in this repository to access scene-specific documentation. They are listed [here](scenes/scenes)
...
Please check [this](technique/techs) for detailed information on each technique.
...
## [Arsenal of Penitence](arsenal/arsenal)
...
### [Quick Verses](prayers/verses/verses)
...
Further information [here](prayers/verses/verses).

## Versions

This is a guide for the Steam version 1.0.5 release. More information [here](utils/versions).
